...
If you go for this approach, you might want to set `GARDEN_EXPERIMENTAL_BUILD_STAGE=true`. This will become the default behaviour in a future release and speeds up build staging for projects structured like this.
