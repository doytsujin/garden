...
/**
 * When a `podSpec` is passed to `runAndCopy`, these fields will be omitted from the pod spec used for the runner (and,
 * in some cases, overridden/populated in `runAndCopy`).
 *
 * See: https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.19/#podspec-v1-core
 */
export const runPodSpecBlacklist: (keyof V1PodSpec)[] = [
...
export async function prepareRunPodSpec({
  ...
  podSpec = {
    ...omit(podSpec || {}, runPodSpecBlacklist),
    containers,
    imagePullSecrets,
  }
